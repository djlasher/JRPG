...
func _draw_building(b):
 var r:Rect2=b.rect;draw_rect(r,Color(b.color));draw_polygon(PackedVector2Array([r.position+Vector2(-14,20),r.position+Vector2(r.size.x/2,-55),r.position+Vector2(r.size.x+14,20)]),PackedColorArray([Color(b.color).darkened(.32)]));draw_rect(Rect2(b.door-Vector2(17,45),Vector2(34,45)),Color("211923"));draw_rect(Rect2(b.door-Vector2(20,48),Vector2(40,48)),Color("f2c866"),false,3);draw_colored_polygon(PackedVector2Array([b.door+Vector2(-11,9),b.door+Vector2(11,9),b.door+Vector2(0,20)]),Color("fff0a8"));draw_rect(Rect2(r.position+Vector2(30,70),Vector2(42,35)),Color("9ed6d2"));draw_rect(Rect2(r.end-Vector2(72,r.size.y-70),Vector2(42,35)),Color("9ed6d2"));draw_string(ThemeDB.fallback_font,b.door+Vector2(-r.size.x/2,38),b.name+" — ENTER",HORIZONTAL_ALIGNMENT_CENTER,r.size.x,14,Color("fff1d0"))
